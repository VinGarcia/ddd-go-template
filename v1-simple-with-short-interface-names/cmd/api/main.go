...
import (
	...
	"github.com/vingarcia/ddd-go-template/v1-simple-with-short-interface-names/assets"

	"github.com/vingarcia/ddd-go-template/v1-simple-with-short-interface-names/cmd/api/middlewares"
	"github.com/vingarcia/ddd-go-template/v1-simple-with-short-interface-names/cmd/api/usersctrl"
	"github.com/vingarcia/ddd-go-template/v1-simple-with-short-interface-names/cmd/api/venuesctrl"

	"github.com/vingarcia/ddd-go-template/v1-simple-with-short-interface-names/domain"
	"github.com/vingarcia/ddd-go-template/v1-simple-with-short-interface-names/domain/users"
	"github.com/vingarcia/ddd-go-template/v1-simple-with-short-interface-names/domain/venues"

	"github.com/vingarcia/ddd-go-template/v1-simple-with-short-interface-names/infra/cache"
	"github.com/vingarcia/ddd-go-template/v1-simple-with-short-interface-names/infra/cache/memorycache"
	"github.com/vingarcia/ddd-go-template/v1-simple-with-short-interface-names/infra/cache/redis"
	"github.com/vingarcia/ddd-go-template/v1-simple-with-short-interface-names/infra/env"
	"github.com/vingarcia/ddd-go-template/v1-simple-with-short-interface-names/infra/log"
	"github.com/vingarcia/ddd-go-template/v1-simple-with-short-interface-names/infra/log/jsonlogs"
	"github.com/vingarcia/ddd-go-template/v1-simple-with-short-interface-names/infra/rest/http"

	"github.com/vingarcia/ddd-go-template/v1-simple-with-short-interface-names/infra/repo"
	"github.com/vingarcia/ddd-go-template/v1-simple-with-short-interface-names/infra/repo/pgrepo"
